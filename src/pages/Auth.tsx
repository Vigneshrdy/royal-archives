  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4 md:p-8">
      <div className="w-full max-w-5xl">
        ...
        {/* Main Container */}
        <div className="relative bg-card border border-border rounded-3xl shadow-elevated overflow-hidden min-h-[600px] lg:min-h-[650px]">
          {/* Sliding Overlay Panel */}
          <motion.div
            className="absolute top-0 bottom-0 w-1/2 bg-primary z-20 hidden lg:flex flex-col justify-center px-12 xl:px-16"
            initial={false}
            animate={{
              left: isSignUp ? "50%" : "0%",
          ...
          {/* Forms Container */}
          <div className="flex w-full min-h-[600px] lg:min-h-[650px]">
            {/* Sign In Form */}
            <div className={`w-full lg:w-1/2 flex items-center justify-center p-8 lg:p-12 transition-opacity duration-300 ${isSignUp ? 'lg:opacity-0 lg:pointer-events-none' : ''}`}>
              <motion.div
                initial={false}
                animate={{ 
                  x: isSignUp ? -50 : 0,
            ...
            {/* Sign Up Form */}
            <div className={`w-full lg:w-1/2 flex items-center justify-center p-8 lg:p-12 absolute lg:relative inset-0 lg:inset-auto transition-opacity duration-300 bg-card lg:bg-transparent ${!isSignUp ? 'opacity-0 pointer-events-none lg:opacity-0 lg:pointer-events-none' : ''}`}>
              <motion.div
                initial={false}
                animate={{ 
                  x: !isSignUp ? 50 : 0,
